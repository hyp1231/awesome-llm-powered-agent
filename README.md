...
* ![agent-manager-skill Stars](https://img.shields.io/github/stars/fractalmind-ai/agent-manager-skill) [agent-manager-skill](https://github.com/fractalmind-ai/agent-manager-skill) - tmux + Python agent lifecycle manager for running local CLI agents (start/stop/monitor/assign + cron scheduling).
