...
- [Chidori](https://github.com/ThousandBirdsInc/chidori) <details><summary>A reactive runtime for building durable AI agents</summary>Chidori provides a reactive & durable execution environment designed for building reliable AI agents, complete with observability, evaluation, and robustness features.</details>
- [CleverBee](https://github.com/SureScaleAI/cleverbee) <details><summary>AI-Powered Research Assistant Agent</summary>Python-based agent using LLMs (Gemini/Claude/Local), Playwright for web browsing, and Chainlit for UI. Features MCP Tool Support, multi-LLM architecture, content cleaning, token tracking, and caching.</details>
- [CoLLiE](https://github.com/Hunter-Hester/CoLLiE) <details><summary>CoLLiE: Collaborative Training of Large Language Models in an Edge Environment</summary>This library focuses on enabling the training/fine-tuning of large language models in edge computing environments. </details>
