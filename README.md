...
* [Awesome Claude Multi-Agent](https://github.com/Yigtwxx/awesome-claude-multi-agent) - A curated list for multi-agent orchestration where Claude is a primary model.
