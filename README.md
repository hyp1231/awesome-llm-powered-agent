...
* ![Overloop CLI Stars](https://img.shields.io/github/stars/sortlist/overloop-cli) [Overloop CLI](https://github.com/sortlist/overloop-cli) - AI-powered outbound engine. Source prospects from 450M+ contacts, launch email + LinkedIn campaigns, manage conversations. JSON output, agent-native.
* ![Signals CLI Stars](https://img.shields.io/github/stars/sortlist/signals-cli) [Signals CLI](https://github.com/sortlist/signals-cli) - Intent signal monitoring. Track LinkedIn engagers, keyword posters, job changers, funding events. JSON output for agent pipelines.
