...
- [Agent Rigor](https://github.com/MeherBhaskar/agent-rigor) - A modular markdown framework that enforces software engineering discipline, planning, and verification for autonomous AI agents.
