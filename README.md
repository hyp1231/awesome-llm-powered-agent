...
* ![Autohand Code CLI Stars](https://img.shields.io/github/stars/autohandai/code-cli) [Autohand Code CLI](https://github.com/autohandai/code-cli) - A self-evolving autonomous coding agent using the ReAct pattern with 40+ tools, multi-LLM support (OpenRouter, Anthropic, OpenAI, Ollama), and built-in memory systems.
