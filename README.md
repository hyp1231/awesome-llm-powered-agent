...
* ![alive Stars](https://img.shields.io/github/stars/TheAuroraAI/alive) [alive](https://github.com/TheAuroraAI/alive) - Minimal autonomous AI framework — memory, sessions, circuit breakers, dashboard in one file. Production-hardened through 100+ real sessions.
